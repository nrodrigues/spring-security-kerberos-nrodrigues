...
/**
 * <p>
 * Authentication Provider which validates Kerberos Service Tickets or SPNEGO
 * Tokens (which includes Kerberos Service Tickets).
 * </p>
 * 
 * <p>
 * It needs a <code>KerberosTicketValidator</code>, which contains the code to
 * validate the ticket, as this code is different between SUN and IBM JRE.<br>
 ...
 * @see AbstractSpnegoAuthenticationProcessingFilter
 */
public class KerberosServiceAuthenticationProvider implements AuthenticationProvider, InitializingBean {
	...
	/**
	 * The <code>UserDetailsService</code> to use, for loading the user
	 * properties and the <code>GrantedAuthorities</code>.
	 */
	...
	/**
	 * The <code>KerberosTicketValidator</code> to use, for validating the
	 * Kerberos/SPNEGO tickets.
	 */
