...
public class SpnegoInitToken extends SpnegoToken {
    ...
    public SpnegoInitToken(byte[] token) throws DecodingException {
        try {
            ...
            if(constructed == null || !constructed.isConstructed())
                throw new DecodingException("spnego.token.malformed", null);
	...
	public String toString() {
		return "SpnegoInitToken [mechanisms=" + Arrays.toString(mechanisms) + ", contextFlags=" + contextFlags + ", mechanismToken="
				+ Arrays.toString(mechanismToken) + ", mechanismList=" + Arrays.toString(mechanismList) + ", mechanism=" + mechanism + "]";
	}
